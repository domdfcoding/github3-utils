...
def test_build_secrets_url(github_client):
...
def test_get_public_key(data_regression: DataRegressionFixture, github_client):
	with Betamax(github_client.session) as vcr:
		vcr.use_cassette("test_secrets", record="once")
...
def test_get_secrets(data_regression: DataRegressionFixture, github_client):
	with Betamax(github_client.session) as vcr:
		vcr.use_cassette("test_get_secrets", record="once")
...
def test_encrypt_secret(data_regression: DataRegressionFixture, github_client):
	with Betamax(github_client.session) as vcr:
		vcr.use_cassette("test_secrets", record="once")
...
def test_set_secret(data_regression: DataRegressionFixture, github_client):
	with Betamax(github_client.session) as vcr:
		vcr.use_cassette("test_secrets", record="once")
