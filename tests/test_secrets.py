...
def test_get_public_key(data_regression: DataRegressionFixture):
	github = GitHub(token="FAKE_TOKEN")
...
def test_get_secrets(data_regression: DataRegressionFixture):
	github = GitHub(token="FAKE_TOKEN")
...
def test_encrypt_secret(data_regression: DataRegressionFixture):
	github = GitHub(token="FAKE_TOKEN")
...
def test_set_secret(data_regression: DataRegressionFixture):
	github = GitHub(token="FAKE_TOKEN")
